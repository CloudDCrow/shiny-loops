...
class ShinyLoops:
    def __init__(self, master):
        ...
        locations_label.place(relx=0.5, rely=0.3, anchor=tk.N)

        stationary_label = gui_elements.create_label(master, "imgs/stationary_label.png")
        stationary_label.place(relx=0.5, rely=0.4, anchor=tk.N)

        # Frames
        routes_button_frame1 = gui_elements.create_frame(master, "TFrame")
        routes_button_frame1.place(relx=0.5, rely=0.1, anchor=tk.N)

        routes_button_frame2 = gui_elements.create_frame(master, "TFrame")
        routes_button_frame2.place(relx=0.5, rely=0.2, anchor=tk.N)

        stationary_button_frame1 = gui_elements.create_frame(master, "TFrame")
        stationary_button_frame1.place(relx=0.5, rely=0.5, anchor=tk.N)

        stop_button_frame = gui_elements.create_frame(master, "TFrame")
        stop_button_frame.place(relx=0.5, rely=0.7, anchor=tk.N)
        ...
        self.start_route8_button = gui_elements.create_button(routes_button_frame1, "Route 8",
